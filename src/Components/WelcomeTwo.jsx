  ...
  return (
    <div className="flex justify-center items-center h-screen w-full">
      <div className="flex flex-col gap-6">
        ...
        <div className="mt-4">
          {((first && !pass) || (!pass && !login && !userLogin)) && (
          ...
          {(login || userLogin) && !otpPage && !reset && !first && (
            <p className="font-bold text-[22px] text-[#1e1b39] text-center pb-[4px] font-epilogue">
        ...
        {((!pass && !userLogin) || (reset && !pass) || (first && !pass)) && (
        ...
        {((resetLogin && login && reset) || (firstLogin && first && login)) && (
          <div>
            <div className="relative">
              <p className="text-[#1e1b39] text-xs font-semibold mb-2">Email</p>
              <input
        ...
        {((!auto && !userLogin) || (reset && !auto) || (first && !auto)) && (
          <button
        ...
        {userLogin && !otpPage && !reset && !first && (
          <p className="text-center text-[10px] text-[#000000] mt-2 font-inter cursor-pointer">
            ...
            <span className="text-[#f58220] cursor-pointer" onClick={showFirst}>
              {' '}
              Sign Up
            </span>
          </p>
